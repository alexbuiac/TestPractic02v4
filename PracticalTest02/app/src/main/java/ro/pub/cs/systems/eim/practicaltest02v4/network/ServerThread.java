...
public class ServerThread extends Thread {
    ...
    private final HashMap<String, HttpData> data;
    ...
    public synchronized void setData(String url, HttpData httpData) {
        this.data.put(url, httpData);
    }

    public synchronized HashMap<String, HttpData> getData() {
        return data;
    }
